...
Generate a random hello message with React inside Rails
...
- <a href="https://github.com/tkz96/hello-rails-frontend">Link to React Frontend</a>
- Ruby installed
...
```bash command
git clone https://github.com/tkz96/hello-rails-backend.git
```
